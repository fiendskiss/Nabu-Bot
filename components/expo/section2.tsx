      ...
      <div ref={sectionRef} className="relative min-h-[240svh] md:min-h-[240vh]">
        <div className="sticky top-0 h-[100svh] overflow-hidden md:h-screen">
          ...
          >
            ...
            <motion.div
              className="pointer-events-none absolute left-0 right-0 z-[5] overflow-hidden border-y border-white/10 bg-[linear-gradient(90deg,rgba(96,165,250,0.12),rgba(124,58,237,0.22),rgba(96,165,250,0.12))] shadow-[0_0_60px_rgba(96,165,250,0.08)]"
