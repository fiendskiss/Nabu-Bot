              ...
              >
                <div className="min-w-0 space-y-3">
                  ...
                  <div className="grid gap-3 text-xs uppercase tracking-[0.22em] text-white/44 sm:grid-cols-2">
                    ...
                    <BookingMeta
                      label="Booked For"
                      value={`${formatPreferredDate(entry.preferred_date)} ${formatTimeLabel(entry.preferred_time)}`}
                    />
                  </div>
...
function BookingMeta({
  ...
  return (
    <div className="rounded-[18px] border border-white/10 bg-white/[0.03] px-4 py-3">
      <p className="text-[0.62rem] font-semibold tracking-[0.28em] text-white/34">
        {label}
      </p>
      <p className="mt-2 text-[0.72rem] font-semibold tracking-[0.18em] text-white/68">
        {value}
      </p>
    </div>
  );
