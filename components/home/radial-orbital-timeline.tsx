  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Center orb */}
          <div className="absolute w-16 h-16 rounded-full animate-pulse flex items-center justify-center z-10"
            style={{ background: "linear-gradient(135deg, #7C3AED, #5e00ff, #A855F7)" }}>
              ...
              >
                ...
                className={`
                  ...
                  ${isExpanded 
                    ...
                    : isRelated 
                    ? "border-[#A855F7] animate-pulse text-white"
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2 gap-1">
                            <Link width={10} height={10} className="text-white/70" />
                          ...
                          <div className="flex flex-wrap gap-1">
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                ...
                                >
                                  {relatedItem?.title}
                                  <ArrowRight width={8} height={8} className="ml-1 text-white/60" />
                                </Button>
                              );
                            })}
                          </div>
