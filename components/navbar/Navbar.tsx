...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 py-3">
      ...
      >
        <div className="flex w-[calc(100vw-1.5rem)] items-center justify-between gap-4 px-4 py-2 lg:w-auto lg:justify-center lg:gap-5 lg:px-5">
          <Image
            src="https://res.cloudinary.com/dcmj7quyv/image/upload/v1778150171/Group_1_ibuy94.png"
            alt="Brand Logo"
            width={65}
            height={65}
